...
<CardGroup cols={2}>
  <Card title="Structured output" icon="table" href="/oss/javascript/langchain/frontend/structured-output">
  ...
  <Card title="Message queues" icon="list" href="/oss/javascript/langchain/frontend/message-queues">
