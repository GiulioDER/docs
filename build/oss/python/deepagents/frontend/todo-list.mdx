...
import FrontendTodoListSetupPy from '/snippets/python/code-samples/frontend-todo-list-setup-py.mdx';
import FrontendTodoListSetupJs from '/snippets/python/code-samples/frontend-todo-list-setup-js.mdx';
